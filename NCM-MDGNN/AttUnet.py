...
class ResnetBlock(nn.Module):
    def __init__(self, *, in_channels, out_channels, dropout_rate=0.2, time_emb_dims=256, apply_attention=False):
        ...
        self.act_fn = nn.ReLU()
        # Group 1
        self.normlize_1 = nn.BatchNorm2d(self.in_channels)#(num_groups=8, num_channels=self.in_channels)
        ...
        # Group 3
        self.normlize_2 = nn.BatchNorm2d(self.out_channels) #nn.GroupNorm(num_groups=8, num_channels=self.out_channels)
